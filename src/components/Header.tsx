    ...
    return (
        <header className="glass flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 sticky top-0 z-[100]">
            <div className="flex items-center gap-3">
                ...
                <span className="font-bold text-lg tracking-tight text-black dark:text-white">WeChat-Markdown<span className="hidden sm:inline"> - 公众号排版大师</span></span>
            </div>
            ...
            <div className="flex items-center gap-4">
                ...
                <motion.a
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    href="https://github.com/gzyxds/WeChat-Markdown"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2 rounded-full hover:bg-black/5 dark:hover:bg-white/10 transition-colors"
                >
